...
"$vmd" "-dispdev text -e ~/GitHub/md-scripts/build_prot_lipids/2.create_psf.ld.tcl"
"$vmd" "-dispdev text -e ~/GitHub/md-scripts/build_prot_lipids/3.solvate.ionize.ld.tcl"
