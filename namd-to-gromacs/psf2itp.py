...
for line in psfFile:
    ...
    if len(line) > 0:
        ...
        if line.startswith('PSF'):
            xplor = False
            if 'XPLOR' in segments or 'NAMD' in segments:
                xplor = True
            continue
        ...
        if readpsf == 'atom':
            ...
            if xplor:
            	...
            	if atomtype in index2type:
            		type = index2type[atomtype]
            	else:
                	print "\n\nERROR: No index type", atomtype, "in your parameter files." 
                	print "You may have an XPLOR psf file that does not have the correct header.\nPlease add XPLOR tag to the top of your psf file if it is appropriate.\n\n"
                	exit()
...
if not os.path.exists('output'):
    os.mkdir('output')
if not os.path.exists('output/toppar'):
    os.mkdir('output/toppar')
itpFile = open('output/toppar/charmm36.itp', 'w')
...
itpFile.write(';;\n')
itpFile.write(';; \n')
itpFile.write(';; Modified by Morris Cohen\n')
itpFile.write(';;\n')
...
for imol, molname in enumerate(mol):
    ...
    itpFile = open('output/toppar/'+molname+'.itp', 'w')
...
ndxFile = open('output/index.ndx', 'w')
...
topFile = open('output/topol.top', 'w')
...
topFile.write(';;\n')
topFile.write(';; \n')
topFile.write(';; Modified by Morris Cohen\n')
topFile.write(';;\n')
...
print "Success!! Normal Termination"
print "Your output is located in a directory called output"
print "Please check your index.ndx to ensure that the proper groups have been selected."
print "You may want to create your own index file manually"
